...
{{- define "gx-registry.labelsKubo" -}}
helm.sh/chart: {{ include "gx-registry.chart" . }}
{{ include "gx-registry.selectorLabelsKubo" . }}
{{- if .Chart.AppVersion }}
app.kubernetes.io/version: {{ .Chart.AppVersion | quote }}
{{- end }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
...
{{- define "gx-registry.selectorLabelsKubo" -}}
app.kubernetes.io/name: {{ include "gx-registry.name" . }}-kubo
app.kubernetes.io/instance: {{ .Release.Name }}
{{- end }}
